...
You can use the validator at the command line prompt by typing `python gltf-validator.py <gltf file path to validate>`. You might also add `--validator-path=<path to the official gltf_validator>`.
